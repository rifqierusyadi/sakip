	...
	<div class="col-md-9">
		...
		<div class="box box-success box-solid">
            ...
            <div class="box-body">
				...
				<a href="" class="btn btn-app btn-flat"><i class="fa fa-group"></i> KELUARGA</a>
				<a href="" class="btn btn-app btn-flat"><i class="fa fa-certificate"></i> TANDA JASA</a>
				<a href="" class="btn btn-app btn-flat"><i class="fa fa-gavel"></i> HUKUMAN</a>
				...
				<a href="" class="btn btn-app btn-flat"><i class="fa fa-info"></i> INFO</a>
			</div>
		</div>
              ...
              <div class="tab-pane active" id="data">
                <div class="row">
					<div class="col-md-4">
						...
						<dd>
						<a class="btn btn-xs btn-flat btn-danger pull-right" data-toggle="tooltip" title="Hapus" href="<?= site_url('data/cpns/trash/'.$nip.'/'.pns($nip)->id); ?>"><i class="glyphicon glyphicon-trash"></i></a>
                ...
                <table class="table table-bordered table-striped" id="tableID3">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a class="btn btn-xs btn-flat btn-info" onclick="#" href="#" data-toggle="tooltip" title="Upload"><i class="glyphicon glyphicon-upload"></i></a>
								<a class="btn btn-xs btn-flat btn-warning" onclick="edit_data();" href="#" data-toggle="tooltip" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
								<a class="btn btn-xs btn-flat btn-danger" data-toggle="tooltip" title="Hapus" onclick="#"><i class="glyphicon glyphicon-trash"></i></a></td>
						</tr>
						<?php $no++; ?>
						<?php endforeach; ?>
						<?php endif; ?>
