		...
		<div class="box box-primary box-solid">
			...
			<div class="box-body">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group <?php echo form_error('tujuan') ? 'has-error' : null; ?>">
							<?php
							echo form_label('Tujuan Misi RPJMD','tujuan');
							$data = array('class'=>'form-control','name'=>'tujuan','id'=>'tujuan','type'=>'text','value'=>set_value('tujuan', $record->tujuan));
							echo form_input($data);
							echo form_error('tujuan') ? form_error('tujuan', '<p class="help-block">','</p>') : '';
							?>
						</div>
					</div>
				</div>
