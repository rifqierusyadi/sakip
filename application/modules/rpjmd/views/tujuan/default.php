	...
	<div class="col-md-12">
		...
		<div class="box box-primary box-solid">
			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-12">
						<a class="btn btn-sm btn-flat btn-success" onclick="add_data();" href="<?= site_url('rpjmd/tujuan/created'); ?>"><i class="glyphicon glyphicon-plus"></i> Tambah Data</a>
