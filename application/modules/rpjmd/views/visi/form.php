		...
		<div class="box box-primary box-solid">
			...
			<div class="box-body">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group <?php echo form_error('visi') ? 'has-error' : null; ?>">
							<?php
							echo form_label('Visi','visi');
							$data = array('class'=>'form-control','name'=>'visi','id'=>'visi','type'=>'text','value'=>set_value('visi', $record->visi));
							echo form_input($data);
							echo form_error('visi') ? form_error('visi', '<p class="help-block">','</p>') : '';
							?>
						</div>
					</div>
				</div>
