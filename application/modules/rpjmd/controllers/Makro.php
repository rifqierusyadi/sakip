...
class Makro extends CI_Controller {
	...
	public $folder = 'rpjmd/makro/';
	
	public function __construct()
	{
		parent::__construct();
		$this->load->helper('identitas_helper');
		$this->load->model('makro_m', 'data');
		signin();
		admin();
	}
	...
	{
		$data['head'] 		= 'Kinerja Makro Daerah';
	...
	{
		$data['head'] 		= 'Tambah Kinerja Makro Daerah';
	...
	public function updated($id=null)
	{
		...
		$data['head'] 		= 'Ubah Kinerja Makro Daerah';
	...
	public function ajax_list()
    {
        ...
        foreach ($record as $row) {
			...
			//add html for action
			if(makro($row->id)){
				$col[] = '<a class="btn btn-xs btn-flat btn-success" href="'.site_url('rpjmd/capaian/updated/'.$row->id).'" data-toggle="tooltip" title="Target"><i class="glyphicon glyphicon-ok-circle"></i></a> <a class="btn btn-xs btn-flat btn-warning" onclick="edit_data();" href="'.site_url('rpjmd/makro/updated/'.$row->id).'" data-toggle="tooltip" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
				<a class="btn btn-xs btn-flat btn-danger" data-toggle="tooltip" title="Hapus" onclick="deleted('."'".$row->id."'".')"><i class="glyphicon glyphicon-trash"></i></a>';
			}else{
				$col[] = '<a class="btn btn-xs btn-flat btn-danger" href="'.site_url('rpjmd/capaian/created/'.$row->id).'" data-toggle="tooltip" title="Target"><i class="glyphicon glyphicon-remove-circle"></i></a> <a class="btn btn-xs btn-flat btn-warning" onclick="edit_data();" href="'.site_url('rpjmd/makro/updated/'.$row->id).'" data-toggle="tooltip" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
				<a class="btn btn-xs btn-flat btn-danger" data-toggle="tooltip" title="Hapus" onclick="deleted('."'".$row->id."'".')"><i class="glyphicon glyphicon-trash"></i></a>';
			}
			$data[] = $col;
        }
	...
	public function ajax_save($id=null)
    {
		...
		if($this->validation()){
			...
			helper_log("add", "Menambah Kinerja Makro Daerah");
		}
    }
    ...
    public function ajax_update($id=null)
    {
		...
		if($this->validation($id)){
			...
			helper_log("edit", "Merubah Kinerja Makro Daerah");
		}
    }
    ...
    {
        $this->data->delete($id);
		helper_log("trash", "Menghapus Kinerja Makro Daerah");
	...
	private function validation($id=null)
    {
		...
		$this->form_validation->set_rules("periode_id", "Periode Indikator Makro Kinerja Daerah", "trim|required");
		$this->form_validation->set_rules("indikator", "Indikator Makro Kinerja Daerah", "trim|required");
		$this->form_validation->set_rules("satuan_id", "Satuan Indikator Makro Kinerja Daerah", "trim|required");
	...
	// 					$data = array('class'=>'form-control','name'=>'makro[]','id'=>'makro','type'=>'text','value'=>set_value('makro[]'),'placeholder'=>'makro Sasaran RPJMD');
