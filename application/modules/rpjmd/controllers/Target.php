...
//     }
    ...
    // {
    //     $this->data->delete($id);
	// 	helper_log("trash", "Menghapus Target RPJMD");
	...
	// 					$data = array('class'=>'form-control','name'=>'target[]','id'=>'target','type'=>'text','value'=>set_value('target[]'),'placeholder'=>'target Sasaran RPJMD');
