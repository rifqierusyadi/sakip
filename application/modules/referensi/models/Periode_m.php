...
class Periode_m extends MY_Model
{
	...
	//ajax datatable
    public $column_order = array('periode','awal','akhir',null); //set kolom field database pada datatable secara berurutan
    public $column_search = array('periode','awal','akhir'); //set kolom field database pada datatable untuk pencarian
