				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group <?php echo form_error('periode') ? 'has-error' : null; ?>">
							...
							$data = array('class'=>'form-control','name'=>'periode','id'=>'periode','type'=>'text','value'=>set_value('periode', $record->periode));
					...
					<div class="col-md-12">
						<div class="form-group <?php echo form_error('awal') ? 'has-error' : null; ?>">
							<?php
							echo form_label('Tahun Periode Awal','awal');
							$data = array('class'=>'form-control','name'=>'awal','id'=>'awal','type'=>'text','value'=>set_value('awal', $record->awal));
							echo form_input($data);
							echo form_error('awal') ? form_error('awal', '<p class="help-block">','</p>') : '';
							?>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group <?php echo form_error('akhir') ? 'has-error' : null; ?>">
							<?php
							echo form_label('Tahun Periode Akhir','akhir');
							$data = array('class'=>'form-control','name'=>'akhir','id'=>'akhir','type'=>'text','value'=>set_value('akhir', $record->akhir));
							echo form_input($data);
