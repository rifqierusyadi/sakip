...
class Jabatan extends CI_Controller {
	...
	{
		$data['head'] 		= 'Tambah Master Jabatan';
	...
	public function ajax_save()
    {
        ...
        if($this->validation()){
			...
			helper_log("add", "Menambah Master Jabatan");
        }
    }
    ...
    public function ajax_update($id=null)
    {
        ...
        if($this->validation($id)){
			...
			helper_log("edit", "Merubah Master Jabatan");
        }
    }
    ...
    {
        $this->data->delete($id);
		helper_log("trash", "Menghapus Master Jabatan");
	...
	private function validation($id=null)
    {
		...
		$this->form_validation->set_rules("satker_id", "Satuan Kerja", "trim|required");
		$this->form_validation->set_rules("jenis", "Jenis Jabatan", "trim|required");
		$this->form_validation->set_rules("jabatan", "Nama Jabatan", "trim|required");
		$this->form_validation->set_rules("bup", "BUP", "trim");
