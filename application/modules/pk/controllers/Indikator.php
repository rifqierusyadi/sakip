...
class Indikator extends CI_Controller {
	...
	public function created()
	{
		...
		$data['head'] 		= 'Tambah Indikator Kinerja Utama';
	...
	public function ajax_list()
    {
        ...
        foreach ($record as $row) {
			...
			$col[] = $row->satuan;
			$col[] = $row->periode;
			if(pohon_detail($row->id)){
				$indikator = '<a class="btn btn-xs btn-flat btn-success" href="'.site_url('pk/target/updated/'.$row->id).'" data-toggle="tooltip" title="Target">';
			}else{
