...
class Pns extends CI_Controller {
	...
	public function ajax_list()
    {
        ...
        foreach ($record as $row) {
            ...
            //add html for action
            $col[] = '<a class="btn btn-xs btn-flat btn-warning" onclick="edit_data();" href="'.site_url('referensi/pns/updated/'.$row->id).'" data-toggle="tooltip" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
